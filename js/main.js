...
var attrArray = ["Something1", "Something2", "Something3",
				"Something4", "Something5","Something6"]; //list of attributes from csv data file
...
function makeColorScale(data){
	...
	var colorClasses = ["#ffffff","#a11208","#590b50","#b8e126","#59c7cf","#496ebf", "#49bf8e", "#92bf49"];
